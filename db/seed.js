  ...
  async function createInitalPosts() {
    try{
      ...
      await createPost({
        authorId: albert.id,
        title: "First Post",
        content: "This is my first porst. I hope you love writing blogs as much as I love writing them."
      });

      await createPost({
        authorId: sandra.id,
        title: "YOOOOOOOO",
        content: "whats poppin this is sandra feel free to hmu!",
      });

      await createPost({
        authorId: glamgal.id,
        title: "Moives",
        content: "Who wants to come to the movies with me I have no friends lol"
      });
    }catch(error){
      throw error;
    }
